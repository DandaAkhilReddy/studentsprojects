    ...
    <section className="py-20 px-4 bg-gradient-to-r from-orange-600 via-orange-500 to-yellow-500 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button onClick={onGetStarted} className="bg-black/20 border-2 border-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-black/30 transition">Order Assignment — $49</button>
        </div>
