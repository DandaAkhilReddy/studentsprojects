    ...
    <section className="py-20 px-4 text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button onClick={onGetStarted} className="bg-gray-800 hover:bg-gray-700 border border-gray-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all">Order Assignment — $49</button>
        </div>
